...
typedef NS_ENUM(NSInteger, SQRDTenderType) {
    ...
    /** A payment card. The minimum card payment accepted by the SDK is 100. An attempt to charge a lower amount returns the checkout_amount_below_card_payment_minimum error. The amount limit does not apply to other tender types. */
    SQRDTenderTypeCard,
