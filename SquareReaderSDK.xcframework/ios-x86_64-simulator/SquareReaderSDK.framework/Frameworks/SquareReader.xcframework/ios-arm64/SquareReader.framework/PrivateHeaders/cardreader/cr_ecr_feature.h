...
cr_ecr_result_t cr_ecr_send_rsa_public_key(struct cr_ecr_t *ecr, uint8_t const *modulus, size_t modulus_len,
                                                                 uint8_t const *public_exponent, size_t public_exponent_len,
                                                                 char const *key_id);

cr_ecr_result_t cr_ecr_get_format4_pinblock(struct cr_ecr_t *ecr, uint8_t *pin, size_t pin_len, uint8_t *pinblock, size_t pinblock_len);
