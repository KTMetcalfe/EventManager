...
/**
 !!! DEPRECATED! Prefer `nonull` or `_Nonnull` on the return type instead.

 Mark the return type of a method or function as returning a non-nil value.

 Example:

  - (NSString *)description SQ_NONNULL_RETURN;
 */
#define SQ_NONNULL_RETURN \
