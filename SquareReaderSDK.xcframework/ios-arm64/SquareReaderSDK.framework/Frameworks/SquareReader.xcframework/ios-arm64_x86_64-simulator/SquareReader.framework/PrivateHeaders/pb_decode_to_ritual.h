 ...
 */
bool pb_decode_to_ritual(pb_istream_t *stream, const pb_msgdesc_t fields[], void *dest_struct);
 ...
 */
bool pb_decode_to_ritual_noinit(pb_istream_t *stream, const pb_msgdesc_t fields[], void *dest_struct);
